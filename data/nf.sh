...
function Global_UnlockTest() {
    ...
    echo -e "\E[40;1;37m|                  • DNS STAT •                   |\E[0m"
    echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
function CheckV4() {
    if [[ "$language" == "e" ]]; then
        ...
        if [[ "$NetworkType" == "6" ]]; then
           ...
           echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
           echo -e " ${Font_SkyBlue}** Your network is 12: ${local_isp4}${Font_Suffix} "
            check4=$(ping 1.1.1.1 -c 1 2>&1)
            if [[ "$check4" != *"unreachable"* ]] && [[ "$check4" != *"Unreachable"* ]]; then
                isv4=1
            else
    ...
    if [[ "$language" == "e" ]]; then
        ...
        if [[ "$NetworkType" == "4" ]]; then
            ...
            if [[ "$check6_1" -ne "000" ]] || [[ "$check6_2" -ne "000" ]]; then
                ...
                echo "--------------------------------"
                echo -e " ${Font_SkyBlue}** Your network is 456: ${local_isp6}${Font_Suffix} "
                isv6=1
            else
